...
public class Administration_EditFunctionality_StoreManagement {
	...
	public Administration_EditFunctionality_StoreManagement(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//td[contains(text(),'OTTAWA')]/following-sibling::td[7]/span[1]")
	...
	public void setName(String s1Name) {
		storeName.clear();
		storeName.sendKeys(s1Name);
	}
	public void setPostalCode(String posCode){
		postalCode.clear();
	...
	public void setStName(String stName){
	 ...
	 public void validationCheck() {
		 if(confirmModalMessage.getText().equals("Are you sure you want to update this Store?")) {
	 ...
	 public void fieldsValidation() {
	  ...
	  storName = js.executeScript("return document.getElementById('Body_StoreName').value").toString();
	  strName = js.executeScript("return document.getElementById('Body_Street').value").toString();
