...
public class CureUser_PartialExchangeDummyCompPage {
  
	public WebDriver driver;
	public CureUser_PartialExchangeDummyCompPage(WebDriver driver) {
		this.driver = driver;
    ...
    @FindBy(xpath="//a[@id='Modal_LinkButton1']")
	...
	@FindBy(xpath="//table[@id='DataTables_Table_8']/tbody/tr[1]/td[1]/following-sibling::td[5]/div/label")
	...
	public void partialExchangeDummyComp() throws Exception {
		...
		WebElement partialExchangeDummyCompBtn;
		...
		Thread.sleep(2000);
		partialExchangeDummyCompBtn=driver.findElement(By.xpath("//table[@id='tbl_Articles']/tbody/tr[1]/td[5]/div[1]"));
		partialExchangeDummyCompBtn.click();
		Thread.sleep(1000);
		...
		quantity.sendKeys("2");
		comment.click();
		comment.sendKeys("Test11111");
		Thread.sleep(2000);
		Select sel1 = new Select(reason2);
