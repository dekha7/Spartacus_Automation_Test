...
public class CureUser_PrintRequestPage {
  
	public WebDriver driver;
	public CureUser_PrintRequestPage(WebDriver driver) {
		this.driver = driver;
	...
	public void printRequest() throws Exception {
		...
		newRequests.click();
		Thread.sleep(3000);
		WebElement printRequestBtn;
		driver.findElement(By.xpath("//table[@id='Body_gvCustomers']/tbody/tr[1]/td[1]")).click();
		Thread.sleep(1000);
		printRequestBtn=driver.findElement(By.xpath("//table[@id='Body_gvCustomers']/tbody/tr[1]/td[11]/div[contains(@class,'actButton print')]"));
		action.moveToElement(printRequestBtn).build().perform();
		Thread.sleep(6000);
