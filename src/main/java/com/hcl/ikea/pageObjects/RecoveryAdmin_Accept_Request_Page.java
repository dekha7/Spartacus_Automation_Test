...
import org.openqa.selenium.support.ui.Select;
	...
	public class RecoveryAdmin_Accept_Request_Page {
		public WebDriver driver;

		public RecoveryAdmin_Accept_Request_Page(WebDriver driver) {
			this.driver = driver;
		...
		@FindBy(xpath="//p[text()='Confirm the selected request?']") public WebElement confirmModalMessage;
		@FindBy(xpath="//span[text()='>Country']") public WebElement countrySelection;
		@FindBy(xpath="//select[@id='ddlStore']") public WebElement storeSelection;
		...
		@FindBy(xpath="//table[@id='Body_gvCustomers']//tbody//tr[@class='dataTableData col odd shown selected']//td//input[@title='Accept']") public WebElement acceptBtn;
		public void clickOnRequest() throws InterruptedException {
			...
			Thread.sleep(1000);
			Select store = new Select(storeSelection);
			store.selectByValue("385");
			Thread.sleep(6000);
		...
		public void recoveryAdminAcceptRequest() throws InterruptedException {
			...
			for(int i=1;i<=rowNewRequest;i++) {
				try {
				boolean acceptIcon=driver.findElement(By.xpath("//table[@id='Body_gvCustomers']/tbody/tr["+Integer.toString(i)+"]/td/input[@title='Accept']")).isDisplayed();
				if(acceptIcon==true) {
