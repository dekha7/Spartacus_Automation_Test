...
public class RecoveryUser_RejectRequestPage {
  
	public WebDriver driver;
	public RecoveryUser_RejectRequestPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//table[@id='NewRequestsTable']//tbody//tr[@class='dataTableData col odd shown selected']//td//div[@title='Reject']") public WebElement rejectBtn;
	...
	public void rejectRequest() throws Exception {
        ...
        Thread.sleep(3000);
        radioBtn.click();
		if(selectModalMessage.getText().equals("Why do you reject the request?")) {
			selectModalodalNextBtn.click();
		}else {
			selectModalCancelBtn.click();
		}
	}
