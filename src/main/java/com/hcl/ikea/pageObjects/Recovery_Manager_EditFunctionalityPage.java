...
public class Recovery_Manager_EditFunctionalityPage {
  
	public WebDriver driver;
	public Recovery_Manager_EditFunctionalityPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//td[contains(text(),'249')]/following-sibling::td[7]/span[1]")
	...
	public void scrollDownEditBtn() throws Exception {
		/*
		 * int rowNos =
	...
	public void selectStoreIDRM() {
		Select sel = new Select(storeID);
		sel.selectByValue("249");
	}
	...
	public void verifyeditedUserName() throws InterruptedException { 
