...
public class ValidatePictureAdminOfRangeManagement_ApproveBtnValidation {

	public WebDriver driver;

	public ValidatePictureAdminOfRangeManagement_ApproveBtnValidation(WebDriver driver) {
		this.driver = driver;
	...
	public void verifyApproveButton() throws Exception {
