...
public class ValidatePictureAdminOfRangeManagement_SendMailValidation {

	public WebDriver driver;

	public ValidatePictureAdminOfRangeManagement_SendMailValidation(WebDriver driver) {
		this.driver = driver;
	...
	public void verifySendMail() throws Exception {
